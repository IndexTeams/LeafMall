package cn.kiroe.mall.search.model;

import cn.kiroe.mall.es.util.ESConst;
...
@Data
@Document(indexName = GoodsConst.GOODS_INDEX)
public class Goods {
    // 商品Id skuId
    @Id
    private Long id;
    ...
    @Field(type = FieldType.Text, analyzer = ESConst.IK_MAX_WORD)
