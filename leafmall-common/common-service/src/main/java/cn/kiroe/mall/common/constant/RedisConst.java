...
public class RedisConst {
    public static final String LOCAL_CACHE_HELPER = "local:cache:";
    ...
    // hot:score,用于 记录点击热度，没到100 更新es中的数据
    ...
    public static final String USER_CART_KEY_PREFIX = "user:cart:";
    ...
    public static final String PROMO_LOCK_SKUID = "promo:lock:skuId";
